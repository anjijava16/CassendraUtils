package com.iws.cassendra.utils;
...
public class SimpleClient {
	...
	public void loadData() {
		...
		session.execute("INSERT INTO simplex.songs (id, title, album, artist, tags) " + "VALUES ("
				+ "f6071e72-48ec-4fcb-bf3e-379c8a696488," + "'Die Mösch'," + "'In Gold'," + "'Willi Ostermann',"
				+ "{'kölsch', '1996', 'birds'}" + ");");
		session.execute("INSERT INTO simplex.songs (id, title, album, artist, tags) " + "VALUES ("
				+ "fbdf82ed-0063-4796-9c7c-a3d4f47b4b25," + "'Memo From Turner'," + "'Performance'," + "'Mick Jager',"
				+ "{'soundtrack', '1991'}" + ");");
		...
		session.execute("INSERT INTO simplex.playlists (id, song_id, title, album, artist) " + "VALUES ("
				+ "2cc9ccb7-6221-4ccb-8387-f22b6a1b354d," + "f6071e72-48ec-4fcb-bf3e-379c8a696488," + "'Die Mösch',"
				+ "'In Gold'," + "'Willi Ostermann'" + ");");
		session.execute("INSERT INTO simplex.playlists (id, song_id, title, album, artist) " + "VALUES ("
				+ "3fd2bedf-a8c8-455a-a462-0cd3a4353c54," + "fbdf82ed-0063-4796-9c7c-a3d4f47b4b25,"
	...
	public void updateSchema() {
		...
		ResultSet results = session
				.execute("SELECT * FROM simplex.songs " + "WHERE id = 756716f7-2e54-4715-9f00-91dcbea6cf50;");
	 ...
	 * 
	 * @param keyspace
	 *            the keyspace to drop (and all of its data)
	 */
	...
	/**
	 * Creates simple client application that illustrates connecting to a
	 * Cassandra cluster. retrieving metadata, creating a schema, loading data
	 * into it, and then querying it.
	 * 
	 * @param args
	 *            ignored
	 */
